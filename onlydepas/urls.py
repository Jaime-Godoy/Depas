...
from app.views import actualizar_inmueble, actualizar_usuario, cambiar_estado_solicitud, eliminar_inmueble, registro_usuario,index,detalle_inmueble, generar_solicitud_arriendo,alta_inmueble,solicitudes_arrendador,dashboard
